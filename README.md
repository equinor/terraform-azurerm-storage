...
| <a name="input_file_storage_retention_policy"></a> [file\_storage\_retention\_policy](#input\_file\_storage\_retention\_policy) | The number of days that files should be retained | `number` | `30` | no |
